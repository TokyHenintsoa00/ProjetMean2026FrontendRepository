            ...
            >
                ...
                <ng-template pTemplate="body" let-shop>
                    <tr class="clickable-row">
                        ...
                        <td (click)="viewProfile(shop)">
                            @for (cat of shop.categorieList; track cat) {
                                <span class="category-badge" style="margin-right:4px;">{{ cat }}</span>
                            }
                            @if (shop.categorieList.length === 0) {
                                <span class="category-badge">Non défini</span>
                            }
                        </td>
                        <td (click)="viewProfile(shop)">
                        ...
                        <td (click)="viewProfile(shop)">
                            <p-rating [(ngModel)]="shop.rating" [readonly]="true"></p-rating>
                        </td>
                ...
                <ng-template pTemplate="emptymessage">
                    <tr>
                        <td colspan="6" style="text-align:center; padding:3rem; color:var(--text-400);">
                            <i class="pi pi-shop" style="font-size:2rem; display:block; margin-bottom:.75rem;"></i>
   ...
   loadBoutique() {
        this.boutiqueService.getAllBoutiqueForAdmin().subscribe({
            next: (data: any[]) => {
                    ...
                    categorieList: shop.id_categorie?.map((c: any) => c.nom) || [],
