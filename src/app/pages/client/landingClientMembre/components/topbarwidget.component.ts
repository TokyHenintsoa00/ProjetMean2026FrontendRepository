...
<header class="topbar">
  ...
  <div class="nav-container hidden lg:flex">
    ...
    <ul class="nav-links">
      <li>
        <a (click)="router.navigate(['/landing'], { fragment: 'home' })" pRipple class="nav-link">
          Accueil
        </a>
      </li>
      <li>
        <a (click)="router.navigate(['/landing'], { fragment: 'features' })" pRipple class="nav-link">
          Promotion
          <span class="nav-badge">Hot</span>
        </a>
      </li>
      <li>
        <a (click)="router.navigate(['/landing'], { fragment: 'highlights' })" pRipple class="nav-link">
          Nouveauté
        </a>
      </li>
    </ul>
