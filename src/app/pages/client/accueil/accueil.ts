    ...
    <div class="grid grid-cols-12 gap-4 mt-20 pb-2 md:pb-20">
        ...
        <div class="col-span-12 lg:col-span-6 my-auto flex flex-col lg:items-end text-center lg:text-right gap-4">
            <div class="flex items-center justify-center bg-purple-200 self-center lg:self-end" style="width:4.2rem;height:4.2rem;border-radius:10px">
                <i class="pi pi-fw pi-mobile" style="font-size:2rem;color:#7e22ce;"></i>
            </div>
            ...
            <span class="text-surface-700 dark:text-surface-100 text-2xl leading-normal ml-0 md:ml-2" style="max-width:650px">
                Lectus arcu bibendum at varius vel pharetra vel turpis nunc. Eget aliquet nibh praesent tristique magna sit amet purus gravida.
            </span>
        </div>
    </div>
    ...
    <div class="grid grid-cols-12 gap-4 my-20 pt-2 md:pt-20">
        <div class="col-span-12 lg:col-span-6 my-auto flex flex-col text-center lg:text-left lg:items-start gap-4">
            <div class="flex items-center justify-center bg-yellow-200 self-center lg:self-start" style="width:4.2rem;height:4.2rem;border-radius:10px">
                <i class="pi pi-fw pi-desktop" style="font-size:1.75rem;color:#a16207;"></i>
            </div>
...
<div id="pricing" class="py-6 px-6 lg:px-20 my-2 md:my-6">
    ...
    <div class="grid grid-cols-12 gap-4 justify-between mt-20 md:mt-0">
        <div class="col-span-12 lg:col-span-4 p-0 md:p-4">
            <div class="p-4 flex flex-col border-2 border-surface-200 dark:border-surface-600 cursor-pointer hover:border-primary duration-300 transition-all" style="border-radius:10px">
                ...
                <div class="my-8 flex flex-col items-center gap-4">
                    ...
                    <button pButton pRipple label="Get Started" class="p-button-rounded border-0 ml-4 font-light bg-blue-500 text-white"></button>
                </div>
                <p-divider></p-divider>
                <ul class="my-8 list-none p-0 flex text-surface-900 dark:text-surface-0 flex-col px-8">
                    <li class="py-2"><i class="pi pi-fw pi-check text-xl text-cyan-500 mr-2"></i><span class="text-xl">Responsive Layout</span></li>
                    <li class="py-2"><i class="pi pi-fw pi-check text-xl text-cyan-500 mr-2"></i><span class="text-xl">Unlimited Push Messages</span></li>
                    <li class="py-2"><i class="pi pi-fw pi-check text-xl text-cyan-500 mr-2"></i><span class="text-xl">50 Support Ticket</span></li>
                    <li class="py-2"><i class="pi pi-fw pi-check text-xl text-cyan-500 mr-2"></i><span class="text-xl">Free Shipping</span></li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-span-12 lg:col-span-4 p-0 md:p-4 mt-6 md:mt-0">
            <div class="p-4 flex flex-col border-2 border-surface-200 dark:border-surface-600 cursor-pointer hover:border-primary duration-300 transition-all" style="border-radius:10px">
                ...
                <div class="my-8 flex flex-col items-center gap-4">
                    ...
                    <button pButton pRipple label="Try Free" class="p-button-rounded border-0 ml-4 font-light bg-blue-500 text-white"></button>
                </div>
                <p-divider></p-divider>
                <ul class="my-8 list-none p-0 flex text-surface-900 dark:text-surface-0 flex-col px-8">
                    <li class="py-2"><i class="pi pi-fw pi-check text-xl text-cyan-500 mr-2"></i><span class="text-xl">Responsive Layout</span></li>
