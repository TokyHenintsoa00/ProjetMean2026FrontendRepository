        ...
        <div class="login-split-card">
            ...
            <div class="right-panel">
                <div class="form-content">
                    ...
                    <form (ngSubmit)="signUp()" #myForm="ngForm">
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-6">
                            <div>
                                ...
                                <input 
                                    ...
                                    type="date" 
                                    class="w-full split-input" 
                                    [(ngModel)]="loginUser.dateNaissance" 
                                    [ngModelOptions]="{standalone: true}" 
                                    name="dateNaissance" 
                                />
                            </div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <p-password 
                                    ...
                                    [feedback]="false"
                                ></p-password>
                                 <small *ngIf="passwordError" class="text-red-500 mt-2 block">
                                    {{ passwordError }}
                                </small>
                            </div>
                        </div>
