...
//                         <h2 class="text-4xl font-bold text-surface-900 dark:text-surface-0 mb-3">S'inscrire a notre site</h2>
...
@Component({
    selector: 'app-signup',
    standalone:true,
    imports: [ButtonModule, CheckboxModule, InputTextModule, PasswordModule, FormsModule, RouterModule, RippleModule, CalendarModule, DropdownModule, AppFloatingConfigurator],
    template:`<app-floating-configurator />
<div class="min-h-screen min-w-screen overflow-hidden flex items-center justify-center p-4" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%);">
    <div class="login-container">
        <div class="login-split-card">
                ...
                <div class="form-content">
                    ...
                    <form (ngSubmit)="login()" #myForm="ngForm">
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-6">
                            <div>
                                <label for="nom" class="block text-surface-900 dark:text-surface-0 text-base font-semibold mb-2">Nom</label>
                                <input 
                                    pInputText 
                                    id="nom" 
                                    type="text" 
                                    ...
                                    class="w-full split-input" 
                                    [(ngModel)]="signupUser.nom" 
                                    [ngModelOptions]="{standalone: true}" 
                                    name="nom" 
                                />
                            </div>
                            <div>
                                <label for="prenom" class="block text-surface-900 dark:text-surface-0 text-base font-semibold mb-2">Prénom</label>
                                <input 
                                    pInputText 
                                    id="prenom" 
                                    type="text" 
                        ...
                        <!-- Date de naissance et Rôle sur la même ligne -->
                        <div class="grid grid-cols-2 gap-4 mb-6">
                            <div>
                                <label for="dateNaissance" class="block text-surface-900 dark:text-surface-0 text-base font-semibold mb-2">Date de naissance</label>
                                <p-calendar 
                                    id="dateNaissance" 
                                    [(ngModel)]="signupUser.dateNaissance" 
                                    [ngModelOptions]="{standalone: true}" 
                                    placeholder="JJ/MM/AAAA"
                                    dateFormat="dd/mm/yy"
                                    [showIcon]="true"
                                    styleClass="split-calendar"
                                    [fluid]="true"
                                    [maxDate]="maxDate"
                                ></p-calendar>
                            </div>
                            <div>
                                <label for="role" class="block text-surface-900 dark:text-surface-0 text-base font-semibold mb-2">Rôle</label>
                                <p-dropdown 
                                    id="role" 
                                    [options]="roles" 
                        ...
                        <div class="mb-6">
                            <label for="telephone" class="block text-surface-900 dark:text-surface-0 text-base font-semibold mb-2">Numéro de téléphone</label>
                            <input 
                                pInputText 
                                id="telephone" 
                                type="tel" 
                    ...
                    <div class="text-center mt-8">
                        <p class="text-muted-color mb-4">Vous avez déjà un compte?</p>
                        <p-button 
                            label="Se connecter" 
                            styleClass="w-full p-button-outlined split-button-outlined" 
                            routerLink="/login"
...
/* Calendar Styles */
:host ::ng-deep .split-calendar .p-calendar {
    width: 100%;
}

:host ::ng-deep .split-calendar .p-inputtext {
    padding: 16px !important;
    border: 2px solid #e5e7eb !important;
    border-radius: 12px !important;
    font-size: 15px !important;
...
:host ::ng-deep .split-calendar .p-inputtext:hover {
    border-color: #d1d5db !important;
}

:host ::ng-deep .split-calendar .p-inputtext:focus {
    outline: none !important;
    border-color: #10b981 !important;
    box-shadow: 0 0 0 3px rgba(16, 185, 129, 0.1) !important;
}
...
/* Dropdown Styles */
:host ::ng-deep .split-dropdown .p-dropdown {
    width: 100%;
    border: 2px solid #e5e7eb !important;
    border-radius: 12px !important;
    transition: all 0.3s ease !important;
...
:host ::ng-deep .split-dropdown .p-dropdown:hover {
    border-color: #d1d5db !important;
}

:host ::ng-deep .split-dropdown .p-dropdown:focus {
    outline: none !important;
    border-color: #10b981 !important;
    box-shadow: 0 0 0 3px rgba(16, 185, 129, 0.1) !important;
}

:host ::ng-deep .split-dropdown .p-dropdown .p-dropdown-label {
    padding: 16px !important;
    font-size: 15px !important;
}
