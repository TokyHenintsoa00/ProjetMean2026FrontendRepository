    ...
    <div class="brand-panel">
      <div class="brand-inner">
        <div class="brand-logo">
          ...
          <span class="brand-name">ShopMall Admin</span>
        </div>
        <div class="brand-headline">
          <div class="headline-tag">Panneau d'administration</div>
          <h1 class="headline-title">Bienvenue<br/>sur votre<br/><span class="headline-accent">dashboard</span></h1>
          <p class="headline-sub">Gérez vos boutiques, suivez les performances, contrôlez les commandes et administrez la plateforme en toute sécurité.</p>
        </div>
    ...
    <div class="form-panel">
      <div class="form-inner">
        <div class="form-header">
          <h2 class="form-title">Accès administrateur</h2>
          <p class="form-subtitle">Connectez-vous avec vos identifiants admin</p>
        </div>
        ...
        <div class="signup-row" style="margin-top: 1.5rem;">
          <span>Accès restreint aux administrateurs autorisés.</span>
        </div>
        <div class="signup-row">
          <span>Problème de connexion ?</span>
          <a routerLink="/support" class="signup-link">
...
.stat-num { font-family: 'DM Sans', sans-serif; font-size: 1.3rem; font-weight: 800; color: white; }
