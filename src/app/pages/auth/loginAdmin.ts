    ...
    <div class="brand-panel">
      <div class="brand-inner">
        ...
        <div class="brand-headline">
          ...
          <h1 class="headline-title">Bienvenue<br/>sur votre<br/><span class="headline-accent">espace Admin</span></h1>
    ...
    <div class="form-panel">
      <div class="form-inner">
        ...
        <div class="form-header">
          <h2 class="form-title">Se connecter en tant que admin</h2>
